...
def save_deposit_rate():
    ...
    if data_dicts:
        dal_util.save_data(DepositsRate, data_dicts)
...
def save_loan_rate():
    ...
    if data_dicts:
        dal_util.save_data(LoanRate, data_dicts)
...
def save_required_reserves_rate():
    ...
    if data_dicts:
        dal_util.save_data(RequiredReservesRate, data_dicts)
...
def save_money_supply():
    ...
    if data_dicts:
        dal_util.save_data(MoneySupply, data_dicts)
...
def save_money_supply_bal():
    ...
    if data_dicts:
        dal_util.save_data(MoneySupplyBal, data_dicts)
...
def save_gdp_year():
    ...
    if data_dicts:
        dal_util.save_data(GrossDomesticProductYear, data_dicts)
...
def save_gdp_quarter():
    ...
    if data_dicts:
        dal_util.save_data(GrossDomesticProductQuarter, data_dicts)
...
def save_gdp_three_demands():
    ...
    if data_dicts:
        dal_util.save_data(GdpThreeDemands, data_dicts)
...
def save_gdp_three_industry_pull():
    ...
    if data_dicts:
        dal_util.save_data(GdpThreeIndustryPull, data_dicts)
...
def save_gdp_three_industry_contrib():
    ...
    if data_dicts:
        dal_util.save_data(GdpThreeIndustryContrib, data_dicts)
...
def save_cpi():
    ...
    if data_dicts:
        dal_util.save_data(CPI, data_dicts)
...
def save_ppi():
    ...
    if data_dicts:
        dal_util.save_data(PPI, data_dicts)
